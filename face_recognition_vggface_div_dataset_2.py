...
div_face=extract_face('C:/Users/u27c79/Documents/Project/Face_recongnition_System/image_dataset/image_0.jpg')
div_embedding=get_embeddings(div_face)
...
while True:
    ...
    if k%256 == 27:
        ...
        #embeddings=get_embeddings(face)
            print([is_match(div_embedding,embeddings),img_name],"\n")
        expect IndexError:
            pass
    img_counter += 1
